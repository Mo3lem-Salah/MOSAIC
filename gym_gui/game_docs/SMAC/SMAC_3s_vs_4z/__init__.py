"""Documentation for SMAC v1: 3s_vs_4z (3s_vs_4z)."""
...
def get_smac_3s_vs_4z_html() -> str:
    """Generate HTML documentation for the 3s_vs_4z map."""
    return f"""
<h2>SMAC v1: 3s_vs_4z</h2>
...
Control 3 Stalkers to defeat 4 Zealots controlled by the SC2 built-in AI.
</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Map Name</td><td style="border: 1px solid #ddd; padding: 8px;"><code>3s_vs_4z</code></td></tr>
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Enemies</td><td style="border: 1px solid #ddd; padding: 8px;">4 Zealots</td></tr>
...
<p><b>Notes:</b> Harder kiting scenario with an extra enemy Zealot, demanding more precise positioning to avoid being surrounded.</p>
...
SMAC_3S_VS_4Z_HTML = get_smac_3s_vs_4z_html()

__all__ = ["SMAC_3S_VS_4Z_HTML", "get_smac_3s_vs_4z_html"]
