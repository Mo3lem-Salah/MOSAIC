"""Documentation for SMAC v1: 8m_vs_9m (8m_vs_9m)."""
...
def get_smac_8m_vs_9m_html() -> str:
    """Generate HTML documentation for the 8m_vs_9m map."""
    return f"""
<h2>SMAC v1: 8m_vs_9m</h2>
...
Control 8 Marines to defeat 9 Marines controlled by the SC2 built-in AI.
</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Map Name</td><td style="border: 1px solid #ddd; padding: 8px;"><code>8m_vs_9m</code></td></tr>
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Enemies</td><td style="border: 1px solid #ddd; padding: 8px;">9 Marines</td></tr>
...
<p><b>Notes:</b> Asymmetric Marine battle -- allies are outnumbered by one enemy unit, requiring precise focus fire.</p>
...
SMAC_8M_VS_9M_HTML = get_smac_8m_vs_9m_html()

__all__ = ["SMAC_8M_VS_9M_HTML", "get_smac_8m_vs_9m_html"]
