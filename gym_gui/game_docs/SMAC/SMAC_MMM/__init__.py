"""Documentation for SMAC v1: MMM (MMM)."""
...
def get_smac_mmm_html() -> str:
    """Generate HTML documentation for the MMM map."""
    return f"""
<h2>SMAC v1: MMM</h2>
...
Control 1 Medivac + 2 Marauders + 7 Marines to defeat 1 Medivac + 2 Marauders + 7 Marines controlled by the SC2 built-in AI.
</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Map Name</td><td style="border: 1px solid #ddd; padding: 8px;"><code>MMM</code></td></tr>
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Enemies</td><td style="border: 1px solid #ddd; padding: 8px;">1 Medivac + 2 Marauders + 7 Marines</td></tr>
...
<p><b>Notes:</b> Symmetric mixed-unit battle with healing support. Medivacs must be kept alive and used to heal biological units (Marines, Marauders) while Marauders and Marines provide DPS.</p>
...
SMAC_MMM_HTML = get_smac_mmm_html()

__all__ = ["SMAC_MMM_HTML", "get_smac_mmm_html"]
