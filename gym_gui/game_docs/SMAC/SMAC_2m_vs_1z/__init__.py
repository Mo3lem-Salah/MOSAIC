"""Documentation for SMAC v1: 2m_vs_1z (2m_vs_1z)."""
...
def get_smac_2m_vs_1z_html() -> str:
    """Generate HTML documentation for the 2m_vs_1z map."""
    return f"""
<h2>SMAC v1: 2m_vs_1z</h2>
...
Control 2 Marines to defeat 1 Zealot controlled by the SC2 built-in AI.
</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Map Name</td><td style="border: 1px solid #ddd; padding: 8px;"><code>2m_vs_1z</code></td></tr>
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Allies</td><td style="border: 1px solid #ddd; padding: 8px;">2 Marines (2 agents)</td></tr>
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Enemies</td><td style="border: 1px solid #ddd; padding: 8px;">1 Zealot</td></tr>
...
<p><b>Notes:</b> Small asymmetric-race scenario. Good introductory task for learning to coordinate ranged units against a single melee enemy.</p>
...
SMAC_2M_VS_1Z_HTML = get_smac_2m_vs_1z_html()

__all__ = ["SMAC_2M_VS_1Z_HTML", "get_smac_2m_vs_1z_html"]
