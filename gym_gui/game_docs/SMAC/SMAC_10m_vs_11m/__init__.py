"""Documentation for SMAC v1: 10m_vs_11m (10m_vs_11m)."""
...
def get_smac_10m_vs_11m_html() -> str:
    """Generate HTML documentation for the 10m_vs_11m map."""
    return f"""
<h2>SMAC v1: 10m_vs_11m</h2>
...
Control 10 Marines to defeat 11 Marines controlled by the SC2 built-in AI.
</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Map Name</td><td style="border: 1px solid #ddd; padding: 8px;"><code>10m_vs_11m</code></td></tr>
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Allies</td><td style="border: 1px solid #ddd; padding: 8px;">10 Marines (10 agents)</td></tr>
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Enemies</td><td style="border: 1px solid #ddd; padding: 8px;">11 Marines</td></tr>
...
<p><b>Notes:</b> Asymmetric Marine battle at larger scale than 8m_vs_9m.</p>
...
SMAC_10M_VS_11M_HTML = get_smac_10m_vs_11m_html()

__all__ = ["SMAC_10M_VS_11M_HTML", "get_smac_10m_vs_11m_html"]
