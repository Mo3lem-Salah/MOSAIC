"""Documentation for SMAC v1: 25m (25m)."""
...
def get_smac_25m_html() -> str:
    """Generate HTML documentation for the 25m map."""
    return f"""
<h2>SMAC v1: 25m</h2>
...
Control 25 Marines to defeat 25 Marines controlled by the SC2 built-in AI.
</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Map Name</td><td style="border: 1px solid #ddd; padding: 8px;"><code>25m</code></td></tr>
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Allies</td><td style="border: 1px solid #ddd; padding: 8px;">25 Marines (25 agents)</td></tr>
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Enemies</td><td style="border: 1px solid #ddd; padding: 8px;">25 Marines</td></tr>
...
<p><b>Notes:</b> Large symmetric Marine battle. Tests coordination at scale with many homogeneous units.</p>
...
SMAC_25M_HTML = get_smac_25m_html()

__all__ = ["SMAC_25M_HTML", "get_smac_25m_html"]
