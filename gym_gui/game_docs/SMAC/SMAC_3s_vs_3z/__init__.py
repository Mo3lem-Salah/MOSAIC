"""Documentation for SMAC v1: 3s_vs_3z (3s_vs_3z)."""
...
def get_smac_3s_vs_3z_html() -> str:
    """Generate HTML documentation for the 3s_vs_3z map."""
    return f"""
<h2>SMAC v1: 3s_vs_3z</h2>
...
Control 3 Stalkers to defeat 3 Zealots controlled by the SC2 built-in AI.
</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Map Name</td><td style="border: 1px solid #ddd; padding: 8px;"><code>3s_vs_3z</code></td></tr>
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Enemies</td><td style="border: 1px solid #ddd; padding: 8px;">3 Zealots</td></tr>
...
<p><b>Notes:</b> Kiting scenario: ranged Stalkers vs melee Zealots. Stalkers must maintain distance while dealing damage.</p>
...
SMAC_3S_VS_3Z_HTML = get_smac_3s_vs_3z_html()

__all__ = ["SMAC_3S_VS_3Z_HTML", "get_smac_3s_vs_3z_html"]
