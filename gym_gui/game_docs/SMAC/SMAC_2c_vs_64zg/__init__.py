"""Documentation for SMAC v1: 2c_vs_64zg (2c_vs_64zg)."""
...
def get_smac_2c_vs_64zg_html() -> str:
    """Generate HTML documentation for the 2c_vs_64zg map."""
    return f"""
<h2>SMAC v1: 2c_vs_64zg</h2>
...
Control 2 Colossi to defeat 64 Zerglings controlled by the SC2 built-in AI.
</p>
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Map Name</td><td style="border: 1px solid #ddd; padding: 8px;"><code>2c_vs_64zg</code></td></tr>
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Allies</td><td style="border: 1px solid #ddd; padding: 8px;">2 Colossi (2 agents)</td></tr>
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Enemies</td><td style="border: 1px solid #ddd; padding: 8px;">64 Zerglings</td></tr>
...
<p><b>Notes:</b> Extreme swarm scenario: only 2 allied Colossi (splash-damage units) must survive and defeat a massive Zergling swarm. One of the hardest scenarios in SMAC.</p>
...
SMAC_2C_VS_64ZG_HTML = get_smac_2c_vs_64zg_html()

__all__ = ["SMAC_2C_VS_64ZG_HTML", "get_smac_2c_vs_64zg_html"]
