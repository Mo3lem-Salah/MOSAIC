"""Documentation for SMACv2: 10gen_terran 20v20 (Terran 20v20 scenario preset)."""
...
def get_smacv2_terran_20v20_html() -> str:
    """Generate HTML documentation for the 10gen_terran 20v20 scenario preset."""
    return f"""
<h2>SMACv2: 10gen_terran (20v20)</h2>
...
Team compositions vary every episode with random Terran units (20 allies vs 20 enemies),
...
SMACV2_TERRAN_20V20_HTML = get_smacv2_terran_20v20_html()

__all__ = ["SMACV2_TERRAN_20V20_HTML", "get_smacv2_terran_20v20_html"]
