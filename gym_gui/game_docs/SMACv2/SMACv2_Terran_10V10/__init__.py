"""Documentation for SMACv2: 10gen_terran 10v10 (Terran 10v10 scenario preset)."""
...
def get_smacv2_terran_10v10_html() -> str:
    """Generate HTML documentation for the 10gen_terran 10v10 scenario preset."""
    return f"""
<h2>SMACv2: 10gen_terran (10v10)</h2>
...
Team compositions vary every episode with random Terran units (10 allies vs 10 enemies),
...
<table style="width:100%; border-collapse: collapse; margin: 10px 0;">
    ...
    <tr><td style="border: 1px solid #ddd; padding: 8px;">Base Map</td><td style="border: 1px solid #ddd; padding: 8px;"><code>10gen_terran</code></td></tr>
...
<p><b>Notes:</b> Bio-ball composition with healing support. Marines provide ranged DPS, Marauders slow enemies, and Medivacs heal biological units.</p>
...
SMACV2_TERRAN_10V10_HTML = get_smacv2_terran_10v10_html()

__all__ = ["SMACV2_TERRAN_10V10_HTML", "get_smacv2_terran_10v10_html"]
