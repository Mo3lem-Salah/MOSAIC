"""Documentation for SMACv2: 10gen_terran 20v23 (Terran 20v23 scenario preset)."""
...
def get_smacv2_terran_20v23_html() -> str:
    """Generate HTML documentation for the 10gen_terran 20v23 scenario preset."""
    return f"""
<h2>SMACv2: 10gen_terran (20v23)</h2>
...
Team compositions vary every episode with random Terran units (20 allies vs 23 enemies),
...
SMACV2_TERRAN_20V23_HTML = get_smacv2_terran_20v23_html()

__all__ = ["SMACV2_TERRAN_20V23_HTML", "get_smacv2_terran_20v23_html"]
