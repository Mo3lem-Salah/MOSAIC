"""Documentation for SMACv2: 10gen_zerg 20v23 (Zerg 20v23 scenario preset)."""
...
def get_smacv2_zerg_20v23_html() -> str:
    """Generate HTML documentation for the 10gen_zerg 20v23 scenario preset."""
    return f"""
<h2>SMACv2: 10gen_zerg (20v23)</h2>
...
Team compositions vary every episode with random Zerg units (20 allies vs 23 enemies),
...
SMACV2_ZERG_20V23_HTML = get_smacv2_zerg_20v23_html()

__all__ = ["SMACV2_ZERG_20V23_HTML", "get_smacv2_zerg_20v23_html"]
