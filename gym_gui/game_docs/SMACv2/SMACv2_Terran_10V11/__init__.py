"""Documentation for SMACv2: 10gen_terran 10v11 (Terran 10v11 scenario preset)."""
...
def get_smacv2_terran_10v11_html() -> str:
    """Generate HTML documentation for the 10gen_terran 10v11 scenario preset."""
    return f"""
<h2>SMACv2: 10gen_terran (10v11)</h2>
...
Team compositions vary every episode with random Terran units (10 allies vs 11 enemies),
...
SMACV2_TERRAN_10V11_HTML = get_smacv2_terran_10v11_html()

__all__ = ["SMACV2_TERRAN_10V11_HTML", "get_smacv2_terran_10v11_html"]
