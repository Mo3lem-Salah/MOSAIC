"""Documentation for SMACv2: 10gen_protoss 5v5 (Protoss 5v5 scenario preset)."""
...
def get_smacv2_protoss_5v5_html() -> str:
    """Generate HTML documentation for the 10gen_protoss 5v5 scenario preset."""
    return f"""
<h2>SMACv2: 10gen_protoss (5v5)</h2>
...
Team compositions vary every episode with random Protoss units (5 allies vs 5 enemies),
...
SMACV2_PROTOSS_5V5_HTML = get_smacv2_protoss_5v5_html()

__all__ = ["SMACV2_PROTOSS_5V5_HTML", "get_smacv2_protoss_5v5_html"]
