"""Documentation for SMACv2: 10gen_terran 5v5 (Terran 5v5 scenario preset)."""
...
def get_smacv2_terran_5v5_html() -> str:
    """Generate HTML documentation for the 10gen_terran 5v5 scenario preset."""
    return f"""
<h2>SMACv2: 10gen_terran (5v5)</h2>
...
Team compositions vary every episode with random Terran units (5 allies vs 5 enemies),
...
SMACV2_TERRAN_5V5_HTML = get_smacv2_terran_5v5_html()

__all__ = ["SMACV2_TERRAN_5V5_HTML", "get_smacv2_terran_5v5_html"]
