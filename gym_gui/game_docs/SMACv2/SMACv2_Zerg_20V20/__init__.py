"""Documentation for SMACv2: 10gen_zerg 20v20 (Zerg 20v20 scenario preset)."""
...
def get_smacv2_zerg_20v20_html() -> str:
    """Generate HTML documentation for the 10gen_zerg 20v20 scenario preset."""
    return f"""
<h2>SMACv2: 10gen_zerg (20v20)</h2>
...
Team compositions vary every episode with random Zerg units (20 allies vs 20 enemies),
...
SMACV2_ZERG_20V20_HTML = get_smacv2_zerg_20v20_html()

__all__ = ["SMACV2_ZERG_20V20_HTML", "get_smacv2_zerg_20v20_html"]
